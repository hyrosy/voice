...
const bankOptions = [
    { name: 'Attijariwafa Bank', holder: 'Coming Soon', iban: 'Coming Soon', accountNumber: 'Coming Soon' },
...
    };
    ...
    return (
        <div className="min-h-screen bg-background p-4 md:p-8 pt-20">
            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse lg:grid lg:grid-cols-3 gap-8 pt-20 md:pt-0">
