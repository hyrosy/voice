...
import { Avatar, AvatarFallback } from '@/components/ui/avatar'; // For welcome header
// ---
...
      setClientName(clientProfile?.full_name || user.email.split('@')[0]);
...
            </Avatar>
            <div>
              <h1 className="text-3xl font-bold text-foreground">Welcome, {clientName}</h1>
...
                        {/* Show actor on mobile if screen is too small */}
