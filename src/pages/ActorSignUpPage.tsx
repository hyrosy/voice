                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSignUp} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} required className="w-full p-3 bg-card border border rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" placeholder="e.g., John Doe" />
                        </div>
                        <div>
