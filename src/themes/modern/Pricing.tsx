...
const Pricing: React.FC<any> = ({ data, id, isPreview }) => {
  ...
  const PricingCard = ({ plan }: { plan: any }) => {
    ...
    return (
      ...
      >
        ...
        {/* Features List */}
        <ul className="space-y-4 flex-grow relative z-10 mb-8 pointer-events-none">
        ...
        <div className="relative z-10 mt-auto">
          ...
          >
            <a
              ...
              onClick={(e) => isPreview && e.preventDefault()} // 🚀 SAFE CLICK
            >
  ...
  const RateCardItem = ({ plan }: { plan: any }) => {
    ...
    return (
      <div className="group relative border-b border-white/10 last:border-0 py-6 pointer-events-none md:pointer-events-auto">
        {/* Row 1: Name ...... Price */}
        ...
        <div className="flex justify-between items-end gap-6">
          <p className="text-neutral-400 text-sm leading-relaxed max-w-xl pointer-events-none">
            {plan.features}
          </p>
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="shrink-0 rounded-full border-white/20 text-neutral-300 hover:text-white hover:border-primary hover:bg-primary/10 transition-all pointer-events-auto"
          >
            <a
              href={plan.buttonUrl || "#contact"}
              target={linkTarget}
  ...
  return (
    ...
    >
      ...
      <div className="container max-w-7xl mx-auto relative z-10 px-4">
        {/* 🚀 4. ALWAYS RENDER HEADER FOR INLINE EDITING */}
        ...
        {!hasPlans && isPreview && (
          <div className="w-full py-20 border-2 border-dashed border-white/20 rounded-2xl flex flex-col items-center justify-center text-white/50">
            ...
            <p>
              No pricing plans added yet. Hover over this section and click
              "Edit Pricing" to add plans.
            </p>
          </div>
        )}
              ...
              <div className="relative group/carousel">
                ...
                >
                  {plans.map((plan: any, i: number) => (
                    <div
                      key={i}
                      className="snap-center shrink-0 w-[85vw] sm:w-[350px] h-full"
                    >
              ...
              <div className="max-w-4xl mx-auto bg-neutral-900/30 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
                ...
                <div className="mt-12 text-center pt-6 border-t border-white/5">
                  <Button
                    asChild
                    size="lg"
                    className="rounded-full px-10 h-14 bg-white text-black hover:bg-neutral-200 shadow-xl transition-transform hover:scale-105"
                  >
                    <a
                      href="#contact"
